...
export default function JoinTheCommunity() {
  return (
    <div className="max-w-7xl mx-auto xl:rounded-2xl bg-aesop-dark flex justify-between flex-col md:flex-row items-end h-auto md:h-60 py-8 shadow-md xl:px-10">
      <div className="max-w-md text-2xl font-thin tracking-tight text-sage-2 sm:text-4xl self-start">
        <h2 className="">
