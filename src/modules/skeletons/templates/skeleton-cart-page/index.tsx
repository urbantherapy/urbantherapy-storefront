    ...
    <div className="pt-48 py-12">
      <div className="content-container">
        <div className="grid grid-cols-1 small:grid-cols-[1fr_360px] gap-x-40">
          <div className="flex flex-col bg-sage-1 p-6 gap-y-6">
            <div className="bg-sage-1 flex items-start justify-between">
            ...
            <div>
              ...
              <Table>
                <Table.Header className="border-t-0 border-sage-2">
                  <Table.Row>
                    <Table.HeaderCell className="!pl-0 bg-sage-1">
                      <div className="w-10 h-6 bg-sage-2 animate-pulse" />
                    </Table.HeaderCell>
                    <Table.HeaderCell className="bg-sage-1"></Table.HeaderCell>
                    <Table.HeaderCell className="bg-sage-1">
                      <div className="w-16 h-6 bg-sage-2 animate-pulse" />
                    </Table.HeaderCell>
                    <Table.HeaderCell className="bg-sage-1">
                      <div className="w-12 h-6 bg-sage-2 animate-pulse" />
                    </Table.HeaderCell>
                    <Table.HeaderCell className="!pr-0 bg-sage-1">
