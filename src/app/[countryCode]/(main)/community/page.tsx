        ...
        <div className="content-container pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-0">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 className="mt-4 text-4xl md:text-5xl font-thin tracking-tight sm:text-5xl text-sage-8">
              ...
              <p className="mt-6 text-base md:text-lg leading-6 text-sage-6 sm:max-w-md lg:max-w-xl">
                {`  We’re more than just a store—we’re
                a movement dedicated to empowering makers and fostering
                innovation.`}
              </p>
            </div>
            <div className="mt-14 justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0 hidden md:flex">
